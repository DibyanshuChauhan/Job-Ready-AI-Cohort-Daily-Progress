    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#FBF9F6] dark:bg-[#070708] text-zinc-900 dark:text-zinc-100 transition-colors duration-700 font-sans selection:bg-zinc-900 selection:text-white dark:selection:bg-white dark:selection:text-black md:cursor-none">
      ...
      <div className="w-full lg:w-5/12 bg-[#F5F2EC] dark:bg-[#0E0E10] border-b lg:border-b-0 lg:border-r border-zinc-200/80 dark:border-zinc-800/30 flex flex-col justify-between p-8 md:p-16 lg:p-24 relative overflow-hidden transition-colors duration-700">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-5">
          <div className="absolute left-[10%] top-0 bottom-0 w-px bg-zinc-900 dark:bg-white"></div>
          <div className="absolute left-[30%] top-0 bottom-0 w-px bg-zinc-900 dark:bg-white"></div>
          <div className="absolute left-0 right-0 top-[20%] h-px bg-zinc-900 dark:bg-white"></div>
        ...
        <div className="relative z-10 animate-[fadeIn_0.8s_ease-out]">
          ...
          <div className="h-0.5 w-12 bg-zinc-950 dark:bg-white mb-8"></div>
        </div>
        ...
        <div className="my-12 lg:my-0 relative z-10 max-w-sm animate-[fadeIn_1s_ease-out]">
          ...
          <p className="text-xs tracking-widest leading-relaxed text-zinc-650 dark:text-zinc-400 uppercase font-mono">
            A premium digital archive built for curated garments, contemporary
            streetwear, and raw denim. Designed with absolute restraint.
          </p>
        </div>
      ...
      <div className="w-full lg:w-7/12 flex flex-col justify-between p-8 md:p-16 lg:p-24 relative">
        ...
        <div className="flex justify-between items-center mb-12 lg:mb-0">
          <div className="lg:hidden">
            <span className="font-cinzel text-lg tracking-[0.2em] font-bold text-zinc-955 dark:text-white">
              SNITCH
            </span>
          </div>
          <ThemeToggle />
          ...
          {successData ? (
            ...
            <div className="animate-[fadeIn_0.8s_ease-out]">
              <div className="w-16 h-16 border border-zinc-950 dark:border-white rounded-full flex items-center justify-center mb-8">
                <svg
                  className="w-6 h-6 text-zinc-950 dark:text-white"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth="1.5"
              ...
              <p className="text-sm text-zinc-650 dark:text-zinc-400 mb-8 leading-relaxed font-sans">
                Registration successful. Your signature profile is now
                registered with the Snitch digital archive.
              </p>
              ...
              <div className="border border-zinc-200 dark:border-zinc-800/30 p-6 rounded-lg font-mono text-xs space-y-3 bg-[#F5F2EC]/40 dark:bg-[#0E0E10]/40">
                <div className="flex justify-between border-b border-zinc-200 dark:border-zinc-800/30 pb-2">
                  ...
                  <span className="text-zinc-950 dark:text-zinc-200 truncate max-w-50">
            ...
            <form onSubmit={handleSubmit} className="space-y-8" noValidate>
              ...
              <div className="space-y-6">
                ...
                <div className="relative group">
                  <label
                    htmlFor="fullname"
                    className="text-[10px] font-mono tracking-[0.2em] text-zinc-500 dark:text-zinc-400 uppercase block mb-1"
                  >
                    01 / FULL NAME
                  </label>
                  <input
                  ...
                  <div className="flex items-start">
                    <div className="flex items-center h-5">
                      ...
                      >
                        {formData.isSeller && (
                          <svg
                            className="w-3.5 h-3.5 text-white dark:text-black animate-[popIn_0.2s_ease-out]"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                            strokeWidth="3"
                    ...
                    <div className="ml-3 text-sm">
                      <label
                        htmlFor="isSeller"
                        className="font-mono text-[10px] tracking-[0.2em] text-zinc-700 dark:text-zinc-300 uppercase cursor-pointer"
                      >
                        05 / APPLY FOR MERCHANT ACCESS
                      </label>
                      <p className="text-xs text-zinc-650 dark:text-zinc-450 mt-1">
                        Register as a designer/merchant to list custom garments,
                        bespoke fabrics, and curated clothing lines directly
                        onto the Snitch archive.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="pt-6">
                ...
                <a
                  ...
                  className="mt-3 w-full font-mono text-xs tracking-[0.3em] font-semibold py-4 border border-zinc-300 dark:border-zinc-800 hover:border-zinc-950 dark:hover:border-white transition-all duration-500 select-none uppercase cursor-pointer flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path
                      fill="#4285F4"
                      d="M21.35 12.23c0-.79-.07-1.55-.23-2.27H12v4.3h5.24a4.48 4.48 0 0 1-1.94 2.94v2.45h3.15c1.85-1.7 2.9-4.2 2.9-7.42Z"
                    />
                    <path
                      fill="#34A853"
                      d="M12 21.5c2.65 0 4.87-.88 6.5-2.38l-3.15-2.45c-.88.59-2 0.94-3.35.94-2.57 0-4.75-1.74-5.53-4.08H3.22v2.53A9.82 9.82 0 0 0 12 21.5Z"
                    />
                    <path
                      fill="#FBBC05"
                      d="M6.47 13.53a5.9 5.9 0 0 1 0-3.06V7.94H3.22a9.5 9.5 0 0 0 0 8.12l3.25-2.53Z"
                    />
                    <path
                      fill="#EA4335"
                      d="M12 6.39c1.44 0 2.73.5 3.75 1.48l2.82-2.82C16.87 3.47 14.65 2.5 12 2.5a9.82 9.82 0 0 0-8.78 5.44l3.25 2.53C7.25 8.13 9.43 6.39 12 6.39Z"
                    />
                  </svg>
        ...
        <div className="mt-12 lg:mt-0 pt-8 border-t border-zinc-200 dark:border-zinc-800/20 flex flex-col md:flex-row justify-between items-center text-[10px] font-mono tracking-widest text-zinc-500 dark:text-zinc-400 uppercase space-y-4 md:space-y-0">
          ...
          <div className="space-x-4">
            <span className="hover:text-zinc-950 dark:hover:text-white transition-colors cursor-pointer">
              ARCHIVE COLLECTION
            </span>
            <span>/</span>
            <span className="hover:text-zinc-950 dark:hover:text-white transition-colors cursor-pointer">
